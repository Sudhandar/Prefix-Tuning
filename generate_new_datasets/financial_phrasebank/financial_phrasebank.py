...
train_testvalid = dataset_arrow.train_test_split(test_size=0.2, seed = 8)
# Split the 20% test + valid in half test, half valid
test_valid = train_testvalid['test'].train_test_split(test_size=0.5, seed = 8)
...
print(collections.Counter(train_test_valid_dataset['valid']['label']))
